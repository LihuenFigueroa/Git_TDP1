...
void LCD_send_byte(char address, char data) {
	...
	if (address == 0)
		...
		gpioWrite(LCDRS, ON);
	Chip_GPIO_SetPinState( LPC_GPIO_PORT, LCD_ENABLE_GPIO, LCD_ENABLE_PIN, OFF); // set LCD enable line to 0
...
void LCD_init(char mode1, char mode2) {
	...
	Chip_GPIO_SetDir(LPC_GPIO_PORT, LCD_ENABLE_GPIO, (1 << LCD_ENABLE_PIN),
	OUTPUT);
	...
	Chip_GPIO_ClearValue(LPC_GPIO_PORT, LCD_ENABLE_GPIO, (1 << LCD_ENABLE_PIN));
	Chip_GPIO_ClearValue(LPC_GPIO_PORT, LCD_RS_GPIO, (1 << LCD_RS_PIN));
	Chip_GPIO_ClearValue(LPC_GPIO_PORT, LCD_D1_GPIO, (1 << LCD_D1_PIN));
	Chip_GPIO_ClearValue(LPC_GPIO_PORT, LCD_D2_GPIO, (1 << LCD_D2_PIN));
	Chip_GPIO_ClearValue(LPC_GPIO_PORT, LCD_D3_GPIO, (1 << LCD_D3_PIN));
	Chip_GPIO_ClearValue(LPC_GPIO_PORT, LCD_D4_GPIO, (1 << LCD_D4_PIN));
